...
import banner_2 from "../../assets/images/img1.jpg";
import banner_3 from "../../assets/images/img3.jpg";
import banner_4 from "../../assets/images/img4.jpg";
import banner_5 from "../../assets/images/img5.jpg";
...
function WhyUs() {
  return (
    <div className="component">
      ...
      <hr />
      <h1 className="banner__heading">The way</h1>
      ...
      <div className="banner">
        <div className="banner__contentLeft">
          ...
          <br></br>
          <h4 className="feature__subHeading">Lets ride & stay safe</h4>
